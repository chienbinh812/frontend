...
const ButtonDemo = () => {
    ...
    //       console.log(response.data); // Assuming the API returns an array of products
    //       // Do something with the data, e.g., update the state to display the products
    //     } catch (error) {
            ...
            <div className="col-12 md:col-4">
                <div className="card">
                    ...
                    <div className="flex flex-wrap gap-2">
                        <Button label="Hiển thị danh sách sản phẩm "></Button>
                        <Button label="Thêm sản phẩm"></Button>
                        <Button label="Sửa thông tin sản phẩm" ></Button>
                        <Button label="Xóa sản phẩm"></Button>
                    </div>
                </div>
