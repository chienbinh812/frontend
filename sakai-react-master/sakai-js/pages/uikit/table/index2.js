        ...
        return (
            <React.Fragment>
                <div className="my-2">
                    ...
                    <Button label="Get" icon="pi pi-plus" severity="sucess" className="mr-2" onClick={openNew} />
                    <Button label="Put" icon="pi pi-plus" severity="sucess" className="mr-2" onClick={openNew} />
            ...
            <div className="col-12">
                ...
                <Toolbar className="mb-4" left={leftToolbarTemplate} right={rightToolbarTemplate}></Toolbar>
                    ...
                    >
                        ...
                        <Column field="price" header="Role" style={{ minWidth: '8rem' }} />
                        <Column field="dateOfManufacture" header="Date" style={{ minWidth: '8rem' }} />
